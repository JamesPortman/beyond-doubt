...
export const en: Locale = {
  ...
  ui: {
    ...
    percentileTop: 'Top {n}% by time',
    perfectShare: '{n}% solved it clean',
    refuseTitle: 'Not enough evidence',
    refuseBody: 'You cannot show that {name} {pred} from what you know.',
    refuseWhy: 'There is at least one arrangement of the board that fits every clue you hold where {name} {other} instead.',
    refuseShare: 'Share this board',
    refuseGo: 'Keep going',
    ...
    dimmed: 'Dimmed',
    hidden: 'Hidden',
    showSolvable: 'Mark the solvable square',
    onHint: 'Only when hinted',

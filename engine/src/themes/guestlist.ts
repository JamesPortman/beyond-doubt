...
export const guestlist: Theme = {
  ...
  strings: {
    en: {
      ...
      flavour: [
        'I only came for the pudding.',
        'Nobody has seen the host in an hour.',
        'The dog has been under the table all night.',
        'Someone has moved my chair.',
        'I do not know half these people.',
        'That is the third time the doorbell has gone.',
        'There is far too much salt in this.',
    ...
    pt: {
      ...
      flavour: [
        'Só vim pela sobremesa.',
        'Ninguém vê o anfitrião há uma hora.',
        'O cachorro ficou debaixo da mesa a noite toda.',
        'Alguém mudou minha cadeira de lugar.',
        'Não conheço metade dessas pessoas.',
        'É a terceira vez que tocam a campainha.',
        'Isto está salgado demais.',
    ...
    es: {
      ...
      flavour: [
        'Solo vine por el postre.',
        'Nadie ha visto al anfitrión en una hora.',
        'El perro ha estado bajo la mesa toda la noche.',
        'Alguien ha movido mi silla.',
        'No conozco ni a la mitad de esta gente.',
        'Es la tercera vez que suena el timbre.',
        'Esto lleva muchísima sal.',
        'Me gustaría irme ya a casa.',
      ],
